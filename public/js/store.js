...
function mergeDefaults(data) { return { ...clone(DEFAULTS), ...(data || {}), preferences: { ...DEFAULTS.preferences, ...(data?.preferences || {}) } }; }
...
export const store = {
  ...
  import(json) { const data = mergeDefaults(JSON.parse(json)); return this.save(data); },
